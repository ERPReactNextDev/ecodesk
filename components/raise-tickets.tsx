...
import { ReceivedDialog } from "@/components/raise-tickets-dialog";
import { supabase } from "@/utils/supabase-ticket"; // adjust path if needed
...
export const Tickets: React.FC<RequestProps> = ({
    referenceid,
    department,
    fullname,
}) => {
    ...
    return (
        <Card className="w-full p-4 rounded-xl flex flex-col mt-4">
