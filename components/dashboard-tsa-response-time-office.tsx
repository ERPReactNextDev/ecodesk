...
const TSAResponseTimeOfficeCard = forwardRef((_props: Props, ref) => {
  ...
  downloadCSV() {
    ...
    downloadStyledWorkbookFromCsv(csv, "tsa-response-time-office.xlsx", downloadOptions);
  },
}));
  ...
  return (
    <Card className="shadow-sm hover:shadow-md transition-shadow duration-200 border-border/50">
      <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 pb-3">
        <CardTitle className="text-lg font-semibold">Average Response Time Per TSA (Office)</CardTitle>
...
export default TSAResponseTimeOfficeCard;
